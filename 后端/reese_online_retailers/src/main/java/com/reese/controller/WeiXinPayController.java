...
import com.reese.util.MD5Util;
import com.reese.util.XmlUtil;
...
public class WeiXinPayController {
    ...
    * */
    ...
    //签名是否正确，规则：按参数名称a-z排序,遇到空值的参数不参加签名。
    public static boolean isTenpaySing(String characterEncoding,SortedMap<Object,Object> packageParams,String API_KEY){
        StringBuffer sb=new StringBuffer();
